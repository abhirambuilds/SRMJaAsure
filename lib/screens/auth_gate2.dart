...
class AuthGate2 extends StatefulWidget {
  ...
  @override
  State<AuthGate2> createState() => _AuthGateState2();
}

class _AuthGateState2 extends State<AuthGate2> {
  ...
  Future<void> _routeUser(Session session) async {
    ...
    // block non-SRM emails (same behavior as before)
    if (!email.toLowerCase().endsWith("@srmist.edu.in")) {
      AuthFlags.blockedNonSrm = true;

      // immediate signout BEFORE any navigation
